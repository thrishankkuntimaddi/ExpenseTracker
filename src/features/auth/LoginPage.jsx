...
export default function LoginPage({ onSignIn, onGoSignUp, error, loading }) {
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              ...
              style={{
                ...
                background: email && password && !loading ? 'var(--accent)' : 'var(--surface2)',
                color: email && password && !loading ? '#fff' : 'var(--text-muted)',
                border: 'none', cursor: email && password && !loading ? 'pointer' : 'not-allowed',
